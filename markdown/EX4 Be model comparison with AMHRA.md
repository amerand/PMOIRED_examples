...
-  [How to synthesize VLTI data from a data cube](#formating) (2D image x wavelenhgth). For this we use [AMHRA](https://amhra.oca.eu/AMHRA/index.htm) service and in particular the [Be model star+Keplerian disk](https://amhra.oca.eu/AMHRA/bedisk/input.htm) as described in [Delaa et al. (2011)](https://ui.adsabs.harvard.edu/abs/2011A%26A...529A..87D/abstract)
